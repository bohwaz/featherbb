...
<div class="linkst">
	<div class="inbox">
		<ul class="crumbs">
			...
			<li><span>»&#160;</span><a href="<?= $feather->pathFor('Forum', ['id' => $cur_posting['id'], 'name' => $url_forum]) ?>"><?= Utils::escape($cur_posting['forum_name']) ?></a></li>
<?php if ($feather->request->post('req_subject')): ?>			<li><span>»&#160;</span><?= Utils::escape($feather->request->post('req_subject')) ?></li>
<?php endif; ?>
<?php if (isset($cur_posting['subject'])): ?>			<li><span>»&#160;</span><a href="<?= $feather->pathFor('Topic', ['id' => $tid, 'name' => $url_topic]) ?>"><?= Utils::escape($cur_posting['subject']) ?></a></li>
...
<?php endif; ?>						<label class="required"><strong><?php _e('Message') ?> <span><?php _e('Required') ?></span></strong><br />
						...
						<ul class="bblinks">
							<li><span><a href="<?= $feather->pathFor('help').'#bbcode' ?>" onclick="window.open(this.href); return false;"><?php _e('BBCode') ?>ok</a> <?php echo($feather->forum_settings['p_message_bbcode'] == '1') ? __('on') : __('off'); ?></span></li>
