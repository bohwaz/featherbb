...
<div class="blockform">
	...
	<div class="box">
		<form id="upload_avatar" method="post" enctype="multipart/form-data" action="<?= $feather->pathFor('profileAction', ['id' => $id, 'action' => 'upload_avatar2']) ?>" onsubmit="return process_form(this)">
