...
<div class="box">
	<div class="inbox">
		...
		<p><code>[url=/help/]<?php _e('This help page') ?>[/url]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('help') ?>"><?php _e('This help page') ?></a></samp></p>
		...
		<p><code>[topic=1]<?php _e('Test topic') ?>[/topic]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('Topic', ['id' => '1']) ?>"><?php _e('Test topic') ?></a></samp></p>
		<p><code>[topic]1[/topic]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('Topic', ['id' => '1']) ?>"><?= $feather->pathFor('Topic', ['id' => '1']) ?></a></samp></p>
		<p><code>[post=1]<?php _e('Test post') ?>[/post]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('viewPost', ['pid' => '1']).'#1' ?>"><?php _e('Test post') ?></a></samp></p>
		<p><code>[post]1[/post]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('viewPost', ['pid' => '1']).'#1' ?>"><?= $feather->pathFor('viewPost', ['pid' => '1']).'#1' ?></a></samp></p>
		<p><code>[forum=1]<?php _e('Test forum') ?>[/forum]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('Topic', ['id' => '1']) ?>"><?php _e('Test forum') ?></a></samp></p>
		<p><code>[forum]1[/forum]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('Forum', ['id' => '1']) ?>"><?= $feather->pathFor('Forum', ['id' => '1']) ?></a></samp></p>
		<p><code>[user=2]<?php _e('Test user') ?>[/user]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('userProfile', ['id' => '2']) ?>"><?php _e('Test user') ?></a></samp></p>
		<p><code>[user]2[/user]</code> <?php _e('produces') ?> <samp><a href="<?= $feather->pathFor('userProfile', ['id' => '2']) ?>"><?= $feather->pathFor('userProfile', ['id' => '2']) ?></a></samp></p>
	</div>
	<div class="inbox">
