...
<div class="blockform">
	...
	<div class="box">
		<form id="request_pass" method="post" action="<?= $feather->pathFor('resetPassword') ?>" onsubmit="this.request_pass.disabled=true;if(process_form(this)){return true;}else{this.request_pass.disabled=false;return false;}">
